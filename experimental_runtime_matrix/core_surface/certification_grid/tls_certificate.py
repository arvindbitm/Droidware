...
def ensure_tls_certificates(project_root=None, server_host=None, force=False):
    ...
    for relative_dir in ("core_surface/operator_console", "core_surface/client_runtime"):
    ...
    return {
        ...
        "admin_cert": str(project_root / "core_surface" / "operator_console" / "cert.pem"),
        "client_cert": str(project_root / "core_surface" / "client_runtime" / "cert.pem"),
